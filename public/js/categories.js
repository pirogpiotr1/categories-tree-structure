...
var ManageCategories = function ManageCategories() {
  var _this = this;

  _classCallCheck(this, ManageCategories);

  _defineProperty(this, "homePage", window.location.origin);

  _defineProperty(this, "sortableOptions", {
    group: {
      name: "sortable-list",
      pull: true,
      put: true
    ...
    store: {
      set: function () {
        var _set = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(sortable) {
          var order, response;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return fetch("".concat(window.location.origin, "/change_sort/"), {
                    headers: {
    ...
    onEnd: function () {
      var _onEnd = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(event) {
        var id_to, id_from, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                //id do
                id_to = event.to.dataset.id;
                id_from = event.item.dataset.id;
                _context2.next = 4;
                return fetch("".concat(window.location.origin, "/change_position/"), {
                  headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
                    "X-Requested-With": "XMLHttpRequest",
  ...
  _defineProperty(this, "handleSortable", function () {
    console.log('test');
  });

  _defineProperty(this, "initSortable", function () {
    var els = document.querySelectorAll('.js-sortable');

    for (var i = 0; i < els.length; i++) {
      new sortablejs__WEBPACK_IMPORTED_MODULE_1__["default"](els[i], _this.sortableOptions);
    }
  });
  ...
  _defineProperty(this, "handleRemoveEvent", function (event) {
    var id = event.currentTarget.dataset.id;
  ...
  _defineProperty(this, "handleEdit", function (event) {
  ...
  _defineProperty(this, "removeEl", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(id) {
      var response;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch("".concat(_this.homePage, "/remove_category/"), {
                headers: {
                  "Content-Type": "application/json",
                  "Accept": "application/json",
                  "X-Requested-With": "XMLHttpRequest",
...
module.exports = __webpack_require__(/*! C:\Users\pirog\Documents\web\categories_tree\resources\js\categories.js */"./resources/js/categories.js");
